...
import org.bastanchu.churiservices.deliveries.internal.dao.SystemDao
...
class SystemServiceImpl(@Autowired val systemDao : SystemDao,
    ...
    : SystemService, BaseSystemServiceImpl() {
    ...
    override fun getPostgresqlPingStatus(): PingStatus {
        try {
            ...
            val pingStatus = PingStatus(
                componentName = environment.getProperty("org.bastanchu.churiservices.deliveries.dbSystemName") ?: "",
