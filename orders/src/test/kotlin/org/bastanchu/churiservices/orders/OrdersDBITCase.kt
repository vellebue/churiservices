...
class OrdersDBITCase(@Autowired val environment: Environment,
    ...
    fun retrieveComponentName() : String {
        return environment.getProperty("org.bastanchu.churiservices.orders.systemName") ?: ""
    }

    fun retrieveSystemVersion() : String {
        return environment.getProperty("org.bastanchu.churiservices.orders.systemVersion") ?: ""
    }

    fun retrieveComponentDbName() : String {
        return environment.getProperty("org.bastanchu.churiservices.orders.dbSystemName") ?: ""
    }
}